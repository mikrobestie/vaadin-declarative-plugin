...
public class VDHtmlContentImpl extends ASTWrapperPsiElement implements VDHtmlContent {

  public VDHtmlContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof VDVisitor) ((VDVisitor)visitor).visitHtmlContent(this);
